<template>
  <div>
    <div v-if="serverInfo">
      <p
        v-if="
          serverInfo['38.7.218.60:27021'] && serverInfo['38.7.218.60:27021'].gq_online
        "
      >
        Servidor Encendido
      </p>
      ...
      <p v-if="serverInfo['38.7.218.60:27021']">
        Nombre del Servidor: {{ serverInfo["38.7.218.60:27021"].gq_hostname }}
      </p>
      <p v-if="serverInfo['38.7.218.60:27021']">
        Mapa Actual: {{ serverInfo["38.7.218.60:27021"].gq_mapname }}
      </p>
      <p v-if="serverInfo['38.7.218.60:27021']">
