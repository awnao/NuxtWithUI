<template>
  <div class="info-container">
    <section class="info-section">
      ...
      <div class="p_v1">
        <UButton label="Jugadores" @click="isOpen = true" />
  ...
  >
    <img
      class="box block mx-auto h-24 rounded-full sm:mx-0 sm:shrink-0"
    ...
    <div class="text-center space-y-2 sm:text-left">
      <div class="space-y-0.5">
        <UTooltip text="G.O.A.T">
          <p class="text-lg text-black font-semibold">XxKINGxX</p> </UTooltip
        ><br />
        <UBadge color="sky" variant="subtle">Diseñador / Programador / SJ+</UBadge>
      </div>
      <div>
...
import { defineComponent, ref } from "vue"; export default defineComponent({ data() {
return { serverHostname: null as string | null, serverJugadores: null as number | null,
serverMapname: null as string | null, serverMaxJugadores: null as string | null,
serverJoinlinkServer: null as string | null, serverOnlineServer: null as boolean | null,
players: [] as string[] }; }, async mounted() { try { const response = await
fetch("http://localhost/WEB-COX-CS/"); if (!response.ok) { throw new Error("Network
response was not ok"); } const data = await response.json(); this.serverHostname =
data["38.7.218.60:27021"].gq_hostname; this.serverJugadores =
data["38.7.218.60:27021"].gq_numplayers; this.serverMapname =
data["38.7.218.60:27021"].map; this.serverMaxJugadores =
data["38.7.218.60:27021"].gq_maxplayers; this.serverJoinlinkServer =
data["38.7.218.60:27021"].gq_joinlink; this.serverOnlineServer =
data["38.7.218.60:27021"].gq_online; this.players =
data["38.7.218.60:27021"].players.map((player: any) => player.name); } catch (error) {
console.error("Error fetching server info:", error); } }, setup() { const comandos =
["Comando 1", "Comando 2", "Comando 3"]; const nosotrosInfo = "Información sobre
nosotros..."; const modoInfo = "Modo de funcionamiento..."; const isOpen = ref(false);
return { comandos, nosotrosInfo, modoInfo, isOpen }; }, });
