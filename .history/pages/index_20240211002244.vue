...
export const servidorInfo = "Yozhi raps";
export const comandos = ["Comando 1", "Comando 2", "Comando 3"];
export const nosotrosInfo = "Información sobre nosotros...";
export const modoInfo = "Modo de funcionamiento...";
