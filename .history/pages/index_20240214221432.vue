...
export default defineComponent({
  ...
  setup() {
    ...
    const modoInfo =
      "REGLAMENTO GENERAL:Cualquier tipo de insulto hacia un admin será motivo de BANProhibido abusar del micrófono, en caso de hacerlo le corresponderá GAGREGLAMENTO EN CERRADOS:El FRAG estará permitido mientras pueda estando el antifrag activo, salvo excepciones que serán determinadas por el adminEn el area chica solo podrá ingresar un player que será el arquero del equipoEl arquero no podrá sobrepasar la mitad de la canchaNo se podrá cambiar el arquero, salvo excepcion del adm";
