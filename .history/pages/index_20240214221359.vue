...
export default defineComponent({
  ...
  setup() {
	...
	El FRAG estará permitido mientras pueda estando el antifrag activo, salvo excepciones que serán determinadas por el admin
	En el area chica solo podrá ingresar un player que será el arquero del equipo
