...
sea la pelota, en caso de hacerlo el admin determinará la acción que corresponda.^n")
o de sobrepasar el límite el admin determinará la acción que corresponda.</UL>^n^n")
