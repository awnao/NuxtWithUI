...
export default defineComponent({
  ...
  setup() {
    ...
    const modoInfo = "REGLAMENTO GENERAL:Cualquier tipo de insulto hacia un admin será motivo de BANProhibido abusar del micrófono, en caso de hacerlo le corresponderá GAG
